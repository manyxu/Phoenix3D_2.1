...
function e_CreateEditMenu(tag)
	...
	if 1==tag then
		...
		NirMan:AddMenuItem(createUIMenu, PX2_LM:GetValue("UIRelativeFrame"), "e_CreateUIRelativeFrame(true)")
	...
	elseif 2==tag then
		...
		NirMan:AddMenuItem(createUIMenu, PX2_LM:GetValue("UIRelativeFrame"), "e_CreateUIRelativeFrame(false)")

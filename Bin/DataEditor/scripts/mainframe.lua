...
function e_CreateMainMenu()
	...
	E_MainFrame:AddSeparater(itemEdit)
	E_MainFrame:AddMenuItem(itemEdit, PX2_LM:GetValue("PlayAndStop").."\tAlt-Space", "e_AnimPlayStop()", "edit")
	E_MainFrame:AddMenuItem(itemEdit, PX2_LM:GetValue("ResetPlay").."\tSpace", "e_AnimResetPlay()", "edit")
	--itemview

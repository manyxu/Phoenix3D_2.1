...
//----------------------------------------------------------------------------
void Billboard::SetAnchorPoint (float anchX, float anchZ)
{
	mAnchorPoint[0] = anchX;
	mAnchorPoint[1] = anchZ;
}
//----------------------------------------------------------------------------
void Billboard::SetAnchorPoint (const Float2 &anchor)
{
	mAnchorPoint = anchor;
}
//----------------------------------------------------------------------------
...
void Billboard::GenBuffers ()
{
	...
	float xPos = 0.0f - width * mAnchorPoint[0];
	float zPos = 0.0f - height * mAnchorPoint[1];
	xPos += xPlusPer * width;

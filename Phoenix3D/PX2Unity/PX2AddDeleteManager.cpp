...
//----------------------------------------------------------------------------
void AddDeleteManager::Update(double appSeconds, double elapsedSeconds)
{
	// 更新频率控制
	mFreqElapsingTime -= (float)elapsedSeconds;
	...
	// 加入更新
	{
		...
		{
			(*it)->UpdateTime += (float)elapsedSeconds;
	...
	// 删除更新
	{
		...
		{
			(*it1)->UpdateTime += (float)elapsedSeconds;

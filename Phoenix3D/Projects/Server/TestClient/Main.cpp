	...
	while (connect_Account->GetConnectState() == CONNSTATE_CONNECTED)
	{
		if (sIsHasInput)
		{
			...
			else if (cmd == std::string("reg"))
			{
				...
				{
					printf("ParamWrong£ºreg name passwd\n");
				}
			}
			else if (cmd == std::string("newuser"))
			{
				...
				{
					printf("ParamWrong£º newuser device_id\n");
				}
			}
			else if (cmd == std::string("svlist"))
			{
				...
				{
					printf("ParamWrong£ºsvlist local_ver platform\n");
				}
			}
			else if (cmd == std::string("auth"))
			{
				...
				{
					printf("ParamWrong£ºauth name passwd platform\n");
				}
			}

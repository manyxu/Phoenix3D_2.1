...
PX2_ROOT_LOCAL=/cygdrive/e/linkjoy/xylm/Phoenix3dp3
PX2_BIN_ROOT_LOCAL=/cygdrive/e/linkjoy/xylm/Bin
PX2_DATAFROM=DataAndroid
...
mkdir $GAMEPLAY_ANDROID_ROOT/assets/Data/effects1
...
mkdir $GAMEPLAY_ANDROID_ROOT/assets/Data/logics
...
mkdir $GAMEPLAY_ANDROID_ROOT/assets/Data/notice
...
cp -rf $PX2_BIN_ROOT_LOCAL/$PX2_DATAFROM/boost.xml $GAMEPLAY_ANDROID_ROOT/assets/Data
cp -rf $PX2_BIN_ROOT_LOCAL/$PX2_DATAFROM/version.xml $GAMEPLAY_ANDROID_ROOT/assets/Data
cp -rf $PX2_BIN_ROOT_LOCAL/$PX2_DATAFROM/versionList.dat $GAMEPLAY_ANDROID_ROOT/assets/Data

#defines
for file in $PX2_BIN_ROOT_LOCAL/$PX2_DATAFROM/defines/*
do
if [ -d $file ]; then
...
#effects
for file in $PX2_BIN_ROOT_LOCAL/$PX2_DATAFROM/effects/*
do
if [ -d $file ]; then
...
#effects1
for file in $PX2_BIN_ROOT_LOCAL/$PX2_DATAFROM/effects1/*
do
if [ -d $file ]; then
cp -rf $file $GAMEPLAY_ANDROID_ROOT/assets/Data/effects1
fi
if [ -f $file ]; then
cp $file $GAMEPLAY_ANDROID_ROOT/assets/Data/effects1
fi
done

# engine
for file in $PX2_BIN_ROOT_LOCAL/$PX2_DATAFROM/engine/*
do
if [ -d $file ]; then
...
# fonts
for file in $PX2_BIN_ROOT_LOCAL/$PX2_DATAFROM/fonts/*
do
if [ -d $file ]; then
...
# images
for file in $PX2_BIN_ROOT_LOCAL/$PX2_DATAFROM/images/*
do
if [ -d $file ]; then
...
# language
for file in $PX2_BIN_ROOT_LOCAL/$PX2_DATAFROM/language/*
do
if [ -d $file ]; then
...
#logics
for file in $PX2_BIN_ROOT_LOCAL/$PX2_DATAFROM/logics/*
do
if [ -d $file ]; then
cp -rf $file $GAMEPLAY_ANDROID_ROOT/assets/Data/logics
fi
if [ -f $file ]; then
cp $file $GAMEPLAY_ANDROID_ROOT/assets/Data/logics
fi
done

#models
for file in $PX2_BIN_ROOT_LOCAL/$PX2_DATAFROM/models/*
do
if [ -d $file ]; then
...
# net
for file in $PX2_BIN_ROOT_LOCAL/$PX2_DATAFROM/net/*
do
if [ -d $file ]; then
...
# notice
for file in $PX2_BIN_ROOT_LOCAL/$PX2_DATAFROM/notice/*
do
if [ -d $file ]; then
cp -rf $file $GAMEPLAY_ANDROID_ROOT/assets/Data/notice
fi
if [ -f $file ]; then
cp $file $GAMEPLAY_ANDROID_ROOT/assets/Data/notice
fi
done

# objects
for file in $PX2_BIN_ROOT_LOCAL/$PX2_DATAFROM/objects/*
do
if [ -d $file ]; then
...
# projects
for file in $PX2_BIN_ROOT_LOCAL/$PX2_DATAFROM/projects/*
do
if [ -d $file ]; then
...
# scenes
for file in $PX2_BIN_ROOT_LOCAL/$PX2_DATAFROM/scenes/*
do
if [ -d $file ]; then
...
# scripts
for file in $PX2_BIN_ROOT_LOCAL/$PX2_DATAFROM/scripts/*
do
if [ -d $file ]; then
...
# sounds
for file in $PX2_BIN_ROOT_LOCAL/$PX2_DATAFROM/sounds/*
do
if [ -d $file ]; then

/*
*
* ÎÄ¼þÃû³Æ	£º	PX2VertexColorStdMaterial.cpp
*
*/
...
PX2_IMPLEMENT_RTTI(PX2, Material, VertexColorStdMaterial);
PX2_IMPLEMENT_STREAM(VertexColorStdMaterial);
PX2_IMPLEMENT_FACTORY(VertexColorStdMaterial);
PX2_IMPLEMENT_DEFAULT_NAMES(Material, VertexColorStdMaterial);

//----------------------------------------------------------------------------
VertexColorStdMaterial::VertexColorStdMaterial ()
{
	VertexShader* vshader = new0 VertexShader("PX2.VertexColorStd",
		4, 3, 7, 0, false);
	...
	vshader->SetShaderKey(SKT_VERTEXCOLORSTD);

	PixelShader* pshader = new0 PixelShader("PX2.VertexColorStd",
		2, 1, 0, 1, false);
	...
	pshader->SetShaderKey(SKT_VERTEXCOLORSTD);
...
//----------------------------------------------------------------------------
MaterialInstance* VertexColorStdMaterial::CreateInstance (
...
//----------------------------------------------------------------------------
MaterialInstance* VertexColorStdMaterial::CreateUniqueInstance (	
	Texture2D *diffTex, Light *dirLight, Shine* shine)
{
	VertexColorStdMaterial *mtl = new0 VertexColorStdMaterial(); 
...
// Streaming support.
//----------------------------------------------------------------------------
VertexColorStdMaterial::VertexColorStdMaterial (LoadConstructor value)
	:
Material(value)
{
}
//----------------------------------------------------------------------------
void VertexColorStdMaterial::Load (InStream& source)
{
	...
	PX2_END_DEBUG_STREAM_LOAD(VertexColorStdMaterial, source);
}
//----------------------------------------------------------------------------
void VertexColorStdMaterial::Link (InStream& source)
{
	Material::Link(source);
}
//----------------------------------------------------------------------------
void VertexColorStdMaterial::PostLink ()
{
	Material::PostLink();
...
//----------------------------------------------------------------------------
bool VertexColorStdMaterial::Register (OutStream& target) const
{
...
//----------------------------------------------------------------------------
void VertexColorStdMaterial::Save (OutStream& target) const
{
	...
	PX2_END_DEBUG_STREAM_SAVE(VertexColorStdMaterial, target);
}
//----------------------------------------------------------------------------
int VertexColorStdMaterial::GetStreamingSize (Stream &stream) const
{
...
// profile
//----------------------------------------------------------------------------
int VertexColorStdMaterial::msDx9VRegisters[7] =
	{ 0, 4, 5, 6, 7, 8, 9 };
int VertexColorStdMaterial::msOglVRegisters[7] =
	{ 1, 5, 6, 7, 8, 9, 10 };
int VertexColorStdMaterial::msOpenGLES2VRegisters[7] = 
	{ 0, 0, 0, 0, 0, 0, 0 };
int* VertexColorStdMaterial::msVRegisters[Shader::MAX_PROFILES] =
{
	0,
	msDx9VRegisters,
	msDx9VRegisters,
...
std::string VertexColorStdMaterial::msVPrograms[Shader::MAX_PROFILES] =
{
	// VP_NONE
	"",
...
int VertexColorStdMaterial::msAllPTextureUnits[1] = { 0 };
int* VertexColorStdMaterial::msPTextureUnits[Shader::MAX_PROFILES] =
{
	0,
	msAllPTextureUnits,
	msAllPTextureUnits,
...
std::string VertexColorStdMaterial::msPPrograms[Shader::MAX_PROFILES] =
{
	// PP_NONE
	"",

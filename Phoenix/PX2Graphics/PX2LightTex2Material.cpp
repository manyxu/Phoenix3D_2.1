/*
*
* ÎÄ¼þÃû³Æ	£º	PX2LightTex2Material.cpp
*
*/
...
// Profiles.
//----------------------------------------------------------------------------
int LightTex2Material::msDx9VRegisters[6] = { 0, 4, 8, 9, 10, 11};
int LightTex2Material::msOglVRegisters[6] = { 1, 5, 9, 10, 11, 12};
int LightTex2Material::msOpenGLES2VRegisters[6] = { 0, 0, 0, 0, 0, 0};
...
int LightTex2Material::msDx9PRegisters[1]= {0};
int LightTex2Material::msOglPRegisters[1] = {1};
int LightTex2Material::msOpenGLES2PRegisters[1] = {0};
...
std::string LightTex2Material::msPPrograms[Shader::MAX_PROFILES] =
{
	...
	"	lastColor.rgb = lastColor.rgb * vertexTCoord2.x + FogColor.rgb * (1.0 - vertexTCoord2.x);\n"
